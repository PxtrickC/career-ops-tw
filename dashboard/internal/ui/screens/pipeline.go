...
import (
	...
	"github.com/PxtrickC/career-ops-tw/dashboard/internal/data"
	"github.com/PxtrickC/career-ops-tw/dashboard/internal/model"
	"github.com/PxtrickC/career-ops-tw/dashboard/internal/theme"
)
...
func (m PipelineModel) renderHelp() string {
	...
	brand := lipgloss.NewStyle().Foreground(m.theme.Overlay).Render("career-ops-tw · 台灣求職者開源工具")
