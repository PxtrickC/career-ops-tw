...
import { isKnownStatus } from './lib/states.mjs';
...
// Canonical statuses are loaded from templates/states.yml via lib/states.mjs.
// Use `isKnownStatus()` (imported above) — it covers canonical labels, ids,
// and all aliases (legacy Spanish, zh-TW, English shorthand).
